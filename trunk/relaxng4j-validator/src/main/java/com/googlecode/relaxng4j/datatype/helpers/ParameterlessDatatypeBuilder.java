...
/**
 * Dummy implementation of {@link com.googlecode.relaxng4j.datatype.DatatypeBuilder}.
 * 
 ...
 */
public final class ParameterlessDatatypeBuilder implements com.googlecode.relaxng4j.datatype.DatatypeBuilder {

	/** This type object is returned for the derive method. */
	private final com.googlecode.relaxng4j.datatype.Datatype baseType;
	
	public ParameterlessDatatypeBuilder( com.googlecode.relaxng4j.datatype.Datatype baseType ) {
		this.baseType = baseType;
	}
	
	public void addParameter( String name, String strValue, com.googlecode.relaxng4j.datatype.ValidationContext context )
			throws com.googlecode.relaxng4j.datatype.DatatypeException {
		throw new com.googlecode.relaxng4j.datatype.DatatypeException();
	}
	
	public com.googlecode.relaxng4j.datatype.Datatype createDatatype() throws com.googlecode.relaxng4j.datatype.DatatypeException {
		return baseType;
	}
}
